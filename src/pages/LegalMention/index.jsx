...
const LegalMention = () => {
  return(
    ...
    <ol>
      ...
      <br/><br/>
      <li className="bold">Accessibilité :<br/></li>
      <br/><br/>
      ...
      <br/><br/>
      <li className="bold">Propriété intellectuelle :</li>
      <br/><br/>
      ...
      <br/><br/>
      <li className="bold">Liens hypertextes et cookies :</li>
      <br/><br/>
      ...
      <br/><br/>
      <li className="bold">Protection des biens et des personnes - gestion des données personnelles :</li>
      <br/><br/>
