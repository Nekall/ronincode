...
const LegalMention = () => {
  return(
    ...
    <ol>
      ...
      <li className="bold">1. Informations légales :</li>
      ...
      <br/><br/>
      <li className="bold">2. Présentation et principe :</li>
      <br/><br/>
      ...
      <br/><br/>
      <li className="bold">3. Accessibilité :<br/></li>
      <br/><br/>
      Le site www.ronincode.vercel.app est par principe accessible aux utilisateurs 24-24h, 7-7j, sauf interruption, programmée ou non, pour les besoins de sa maintenance ou en cas de force majeure. En cas d’impossibilité d’accès au service, www.ronincode.vercel.app s’engage à faire son maximum afin de rétablir l’accès au service et s’efforcera alors de communiquer préalablement aux utilisateurs les dates et heures de l’intervention.  N’étant soumis qu’à une obligation de moyen, www.ronincode.vercel.app ne saurait être tenu pour responsable de tout dommage, quelle qu’en soit la nature, résultant d’une indisponibilité du service.
      <br/><br/>
      <li className="bold">4. Propriété intellectuelle :</li>
      <br/><br/>
      Prenom Nom est propriétaire exclusif de tous les droits de propriété intellectuelle ou détient les droits d’usage sur tous les éléments accessibles sur le site, tant sur la structure que sur les textes, images, graphismes, logo, icônes, sons, logiciels…<br/>
      Toute reproduction totale ou partielle du site www.ronincode.vercel.app, représentation, modification, publication, adaptation totale ou partielle de l'un quelconque de ces éléments, quel que soit le moyen ou le procédé utilisé, est interdite, sauf autorisation écrite préalable de Prenom Nom, propriétaire du site à l'email : email@webmaster.fr, à défaut elle sera considérée comme constitutive d’une contrefaçon et passible de poursuite conformément aux dispositions des articles L.335-2 et suivants du Code de Propriété Intellectuelle.
      <br/><br/>
      <li className="bold">5. Liens hypertextes et cookies :</li>
      <br/><br/>
      Le site www.ronincode.vercel.app contient un certain nombre de liens hypertextes vers d’autres sites (partenaires, informations …) mis en place avec l’autorisation de Prenom Nom. Cependant, Prenom Nom n’a pas la possibilité de vérifier l'ensemble du contenu des sites ainsi visités et décline donc toute responsabilité de ce fait quand aux risques éventuels de contenus illicites.<br/>
      L’utilisateur est informé que lors de ses visites sur le site www.ronincode.vercel.app, un ou des cookies sont susceptibles de s’installer automatiquement sur son ordinateur par l'intermédiaire de son logiciel de navigation. Un cookie est un bloc de données qui ne permet pas d'identifier l'utilisateur, mais qui enregistre des informations relatives à la navigation de celui-ci sur le site. <br/>
      ...
      <br/><br/>
      <li className="bold">6. Protection des biens et des personnes - gestion des données personnelles :</li>
      <br/><br/>
